...
def parse_args():
    ...
    root="/mnt/data1/zhx/Weakly_TAL/LACP/"
    parser.add_argument('--data_path', type=str, default='/mnt/data1/zhx/dataset/THUMOS14')
    parser.add_argument('--model_path', type=str, default=root+'models/LACP')
    parser.add_argument('--output_path', type=str, default=root+'outputs/LACP')
    parser.add_argument('--log_path', type=str, default=root+'logs/LACP')
    ...
    parser.add_argument('--model_file', type=str, default="/mnt/data1/zhx/Weakly_TAL/LACP/models/LACP/model_seed_0.pkl", help='the path of pre-trained model file')
